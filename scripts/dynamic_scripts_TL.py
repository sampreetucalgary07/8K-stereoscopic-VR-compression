...
def run_experiments():
    ...
    prev_best_losses = [ 0.04728,0.02165,0.03577,0.04129,0.05596]

    for train_path, config_path, prev_best_loss in zip(diff_train_paths,config_paths,prev_best_losses):
        ...
        for dataset in datasets_to_train:
            print("\nRunning experiment for base model: ", dataset)
            ...
            config["tl_params"]["prev_best_loss"] = prev_best_loss
