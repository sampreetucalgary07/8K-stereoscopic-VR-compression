...
def patches(args):
    ...
    output_folder_path = os.path.join(base_path, patch_config["output_folder_path"])
    output_folder_name = patch_config["output_folder_name"]
    ...
    frame_to_patches(
        ...
        img_dim,
        downsample_factor,
        destination_path=output_folder_path,
